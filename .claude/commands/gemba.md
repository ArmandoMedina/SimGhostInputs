...
Recuerda: el bulto de `qa_runs/` está gitignored; **commitear la evidencia citada es paso obligatorio del cierre** (`/cierra` lo hace con `git add -f`), no cortesía — en el linaje se descubrió una vez que 0 artefactos habían llegado a git.

...
- [ ] **Solape de notas de voz largas** — frases de ~7.5 s se enciman en curvas a <4 s entre sí (demo `_DEMO_VOZ_referencia`); el plan anti-saturación aplica a tonos, no a la duración real del WAV de voz. _Prioridad: Baja._

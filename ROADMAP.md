...
- [ ] **Detección de cambio de marcha (cue `gear`)** — slot ya reservado en `DEFAULT_CONFIG` (`fantasma/viz/pacenotes.py`), sin implementar: requiere leer el canal de marcha de la telemetría y decidir el umbral del cue. Pedido explícito del PO; prioridad mínima. Ver ADR 0027.
